...
$this->form_validation->set_rules('Cities_rediodution', 'Cities_rediodution', 'required|xss_clean|trim');
...
$Cities_rediodution=$this->input->post('Cities_rediodution');
...
'name'=>$name,
'photo'=>$image,
'Cities_rediodution'=>$Cities_rediodution,
