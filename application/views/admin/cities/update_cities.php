                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="radio" id="with_fair" name="city_type" value="1" <?if($cities->city_type==1){echo 'checked';}?>>
                          <label for="with_fair">With Return Fair</label>
                          <input type="radio" id="without_fair" name="city_type" value="2" <?if($cities->city_type==2){echo 'checked';}?>>
