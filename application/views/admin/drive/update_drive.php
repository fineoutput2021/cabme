...
<li><a href="<?php echo base_url() ?>dcadmin/cities/view_cities"><i class="fa fa-undo" aria-hidden="true"></i> View Promocode </a></li>
...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>dcadmin/cities/add_cities_data/<?php echo base64_encode(2); ?>/<?=$id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td>
<input type="text" name="name" class="form-control" placeholder="name" required value="<?=$cities->name?>" />
</td>
</tr>
<tr>
  <td> <strong>Image</strong> <span style="color:red;"><br />Big: 2220px X 1000px<br />Small: 540px X 812px</span></strong> </td>
  <td>
    <input type="file" name="photo" class="form-control" placeholder="" value="<?=$cities->photo?>" />
    <?php if ($cities->photo!="") {  ?>
    <img id="slide_img_path" height=75 width=150 src="<?php echo base_url().$cities->photo ?>">
    <?php } else {  ?>
...
<tr>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="Cities_rediodution" value=" with Return Fair" <?php if ($cities == 'with Return Fair') echo 'checked="checked"'; ?>" /> with Return Fair<br />
      <input type="radio" name="Cities_rediodution" value="without Return Fair" <?php if ($cities == 'without  Return Fair') echo 'checked="checked"'; ?>" /> without  Return Fair<br />
    </td>
  </tr>
</tr>
