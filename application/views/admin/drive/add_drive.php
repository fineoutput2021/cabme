...
<li><a href="<?php echo base_url() ?>dcadmin/drive/view_drive"><i class="fa fa-undo" aria-hidden="true"></i></i> View cities </a></li>
...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>dcadmin/drive/add_drive_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
