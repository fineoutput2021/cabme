    ...
    <div class="row align-items-center px-4 roxy">
      ...
      <div class="col-md-6">
        <ol class="breadcrumb justify-content-md-end">
          ...
          <li class="breadcrumb-item"><a href="<?=base_url()?>Home/all_products/<?=$c_url?>/1"><?=$category_name?></a></li>
...
<div class="main_content" id="wishlist">
  ...
  <div class="section" style="padding-top: 10px;">
            ...
            if (!empty($wihslist)) {
                ?>
                  <span class="htc float-right iWish<?=$type_data[0]->id?>">
                    <a href="javascript:void(0)" product_id="<?=base64_encode($data['id'])?>" type_id="<?=base64_encode($type_data[0]->id)?>" status="remove" onclick="wishlistWithFilter(this)"><i class="fa fa-heart float-right" style="color:red;"></i></a>
                    </li></span>
                  <?php
            } else {?>
                  <span class="htc float-right iWish<?=base64_encode($data['id'])?>">
                    <a href="javascript:void(0)" product_id="<?=base64_encode($data['id'])?>" type_id="<?=base64_encode($type_data[0]->id)?>" status="add" onclick="wishlistWithFilter(this)"><i class="icon-heart float-right" style="color:red;"></i></a>
                    </li></span>
                  <?}
        } ?>
            ...
            <div class="sidebar" style="position: sticky;top: 20%;">
              ...
              <div class="widget">
                <div class="row" style="height: 20px;">
                  ...
                  <p style="margin-left: 20px;font-size: 13px;"> <span style="border-right: 1px solid grey; cursor: pointer;" onclick="location.href='<?=base_url()?>Home/all_products/<?=$url?>/1'"> Clear All </span> &nbsp;<span style="cursor: pointer;" onclick="submitFilters()">Apply</span></p>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body p-0">
                        <p style="text-align: end;font-size: 12px;margin-bottom: 0px;cursor: pointer;" onclick="priceReset()" class="pb-2"> RESET</p>
    ...
    $maxvalue=5000;
                          ...
                          <div id="price_filter" data-min="0" data-min="0" data-max="5000" data-min-value="<?=$minvalue?>" data-max-value="<?=$maxvalue?>" data-price-sign="₹"></div>
                          <div class="price_range">
                            <span> <span id="flt_price"></span></span>
                            <input type="hidden" id="price_first" name="minprice" value="<?=$minvalue?>">
                            <input type="hidden" id="price_second" name="maxprice" value="<?=$maxvalue?>">
                        ...
                        <ul class="list_brand mt-4">
                          ...
                          <li>
                            <div class="custome-checkbox">
                              <input class="form-check-input sizeCheck" <?if (!empty($sized)) { if (in_array($size_filter->id, $sized)) {
                              echo "checked";
                              }
                            }?> type="checkbox" id="s<?=$size_filter->id?>" name="size[]" value="<?=$size_filter->id?>">
                  ...
                  <div class="card">
                    ...
                    <div id="collapseThree" class="collapse scrollbarr" aria-labelledby="headingThree" data-parent="#accordion" style="max-height:11rem;overflow-y: scroll;">
                      <div class="card-body">
                        <div class="row float-right mr-2">
                          <p style="font-size: 12px;margin-bottom: 0px;cursor: pointer;" class="mr-1" onclick="selectColors()"> Select All |</p>
                        ...
                        <ul class="list_brand product_color_switch mt-4">
                          ...
                          <li>
                            <div class="custome-checkbox">
                              <input class="form-check-input clearcolor" <?if (!empty($color)) { if (in_array($olor_filter->id, $color)) {
                              echo "checked";
                              }
                            }?> type="checkbox" id="c<?=$olor_filter->id?>" name="color[]" value="<?=$olor_filter->id?>">
                              <label class="form-check-label colorChecks colorcheckboxes" for="c<?=$olor_filter->id?>"><span data-color="<?=$olor_filter->name?>"  class="colorspann"></span>  <?=$olor_filter->colour_name?></label>
                            </div>
                          </li>
                          <?}}?>
                        </ul>
                    ...
                    <div id="collapse<?=$filter->id?>" class="collapse scrollbarr" aria-labelledby="headingThree" data-parent="#accordion" style="max-height:11rem;overflow-y: scroll;">
                      <div class="card-body">
                        ...
                        foreach ($attributes->result() as $attr) {
                          ...
                          <li>
                            <div class="custome-checkbox">
                              <input class="form-check-input attribute<?=$filter->id?>" type="checkbox" <?if (!empty($attribute)) { if (in_array($attr->id, $attribute)) {
                              echo "checked";
                              }
                              } ?> name="attribute[]" id="f<?=$attr->id?>" value="<?=$attr->id?>">
          ...
          <div class="row no-gutters">
            <div class="col-sm-12" style="margin-top:-15px;">
              <div class="popup_content" style="padding: 0px 20px ;">
                <div class="row mt-2">
                  <div class="col-6">
                    <a href="<?=base_url()?>Home/all_products/<?=$url?>/1" class="btn">CLEAR ALL</a>
                  </div>
                      ...
                      <div class="tab-content shop_info_tab" style="margin-top:5px;">
                        <div class="tab-pane show active" id="price" role="tabpanel" aria-labelledby="price-tab">
                          ...
                          <div class="filter_price">
                            ...
                            <div id="price_filter22" data-min="0" data-max="5000" data-min-value="<?=$minvalue?>" data-max-value="<?=$maxvalue?>" data-price-sign="₹"></div>
                            <div class="price_range">
                          ...
                          <ul class="list_brand mt-4" style="text-align: left;max-height:87vh;overflow:auto;">
                            ...
                            <li>
                              <div class="custome-checkbox">
                                ...
                                }?> type="checkbox" name="size[]" id="size<?=$size_filter->id?>" value="<?=$size_filter->id?>">
                        ...
                        <div class="tab-pane fade" id="color" role="tabpanel" aria-labelledby="color-tab">
                          ...
                          <ul class="list_brand product_color_switch mt-4" style="text-align: left;max-height:82vh;overflow:auto;">
                            ...
                            <li>
                              <div class="custome-checkbox">
                                <input class="form-check-input clearcolor colorCheck"  type="checkbox" name="color[]" <?if (!empty($color)) { if (in_array($olor_filter->id, $color)) {
                              echo "checked";
                              }
                              }?> id="color<?=$olor_filter->id?>" value="<?=$olor_filter->id?>">
                                <label class="form-check-label " for="color<?=$olor_filter->id?>"> <span data-color="<?=$olor_filter->name?>"></span><?=$olor_filter->colour_name?></label>
                              </div>
                            </li>
                            <?}}?>
                          </ul>
                          ...
                          <ul class="list_brand scrollbarr mt-5" style="text-align: left;max-height:80vh;overflow:auto;">
                            ...
                            <li>
                              <div class="custome-checkbox">
                                ...
                                } ?> name="attribute[]" id="attr<?=$attr->id?>" value="<?=$attr->id?>">
...
// alert("hi")
  ...
  function clearColor() {
    // $('.colorChecks').prop("checked", false)
    // $('colorChecks').removeAttr('checked');
    $('.clearcolor').prop('checked', false);
  }
