              ...
              <div class="widget">
                ...
                <div id="accordion" class="accordion accordion_style1 mt-3">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body p-0">
                        ...
                        <div class="filter_price" style="padding: 0px 25px;">
                          <div id="price_filter" data-min="500" data-max="3017" data-min-value="500" data-max-value="2000" data-price-sign="₹"></div>
                  ...
                  <div class="card">
                    ...
                    <div id="collapseSec" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                      <div class="card-body">
                        ...
                        <ul class="list_brand product_color_switch mt-4">
                          ...
                          <li>
                            <div class="custome-checkbox">
                              ...
                              <label class="form-check-label" for="c<?=$olor_filter->id?>"><span data-color="<?=$olor_filter->name?>"></span>
                  ...
                  foreach($filter_main->result() as $filter){
                    $check = $this->db->get_where('tbl_product', array("(JSON_CONTAINS(all_filters,'[\"$filter->id\"]')) > "=> 0,'subcategory_id'=> $subcategory_id))->result();
                    if(!empty($check)){
                    ?>
                  <div class="card">
                    ...
                    <div id="collapse<?=$filter->id?>" class="collapse scrollbarr" aria-labelledby="headingThree" data-parent="#accordion" style="max-height:11rem;overflow-y: scroll;">
                      <div class="card-body">
                        ...
                        foreach($attributes->result() as $attr){
                          $check2 = $this->db->get_where('tbl_product', array("(JSON_CONTAINS(all_attributes,'[\"$attr->id\"]')) > "=> 0,'subcategory_id'=> $subcategory_id))->result();
                          if(!empty($check2)){
                        ?>
                          <li>
                            <div class="custome-checkbox">
          ...
          <div class="row no-gutters">
            <div class="col-sm-12" style="margin-top:-15px;">
              <div class="popup_content" style="padding: 0px 20px ;">
                ...
                <form action="<?=base_url()?>Home/filter_check" id="applyFilteronMobile" method="POST" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="tab-content shop_info_tab" style="margin-top:5px;">
                        <div class="tab-pane show active" id="price" role="tabpanel" aria-labelledby="price-tab">
                          ...
                          <div class="filter_price">
                            <div id="price_filter22" class="reset-price" data-min="500" data-max="5000" data-min-value="1000" data-max-value="2500" data-price-sign="₹"></div>
                            <div class="price_range">
                        ...
                        <input type="hidden" name="redlink" value="<?=$url;?>" /> -->
                        ...
                        <input type="hidden" value="<?=$subcategory_name?>" name="subcategory_name" />
