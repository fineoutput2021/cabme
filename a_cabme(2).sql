...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2022 at 04:09 PM
...
INSERT INTO `tbl_booking` (`id`, `booking_type`, `user_id`, `total_amount`, `promocode`, `promo_discount`, `final_amount`, `payment_type`, `payment_status`, `order_status`, `city`, `car_id`, `start_time`, `end_time`, `cab_type`, `pick_location`, `drop_location`, `start_kilometer`, `end_kilometer`, `fname`, `lname`, `email`, `phone`, `txnid`, `ip`, `date`) VALUES
(1, 2, 2, 500, 9, 5, '100000', 1, 1, 1, '1', 2, '5.00', '10.00', 2, 'sikar', 'jaipur', '10', '50', 'ramesh ', 'singh', 'ram@gmail.com', '9828866639', 'hh', '1.100000.100', '9');
